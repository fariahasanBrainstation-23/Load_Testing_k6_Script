...
export function createRequestLogger(scriptName) {
  ...
  function logRequest({ apiName, requestMethod, url, requestPayload, statusCode, errorMessage, responseTime, responseBody }) {
    const entry = {
      ...
      URL: url || '',
      RequestPayload: stringifyValue(requestPayload),
