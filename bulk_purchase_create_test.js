...
const fileBinary = open('./excel-files/purchase_activateBulk.xlsx', 'b');
const FILE_NAME = 'purchase_activateBulk.xlsx';

const { logRequest, getLogs } = createRequestLogger('bulk_purchase_create_test.js');

// VUS + ITERATIONS_PER_VU: each VU runs ITERATIONS_PER_VU full purchase-create flows independently.
...
export default function () {
  ...
  const bulkRes = triggerBulkUpload(authHeaders, filePath, 'PURCHASE_ACTIVATE');
  logRequest({
